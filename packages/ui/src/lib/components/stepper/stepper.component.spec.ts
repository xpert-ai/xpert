...
@Component({
  ...
  template: `
    <z-stepper
      ...
      #stepper="zStepper"
    >
      <z-step label="Account" [stepControl]="accountForm" errorMessage="Account is required" #firstStep="zStep">
...
describe('ZardStepperComponent', () => {
  async function createHost() {
    ...
    const steps = fixture.debugElement.queryAll(By.directive(ZardStepComponent))
