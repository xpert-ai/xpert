import { type ZardTableSizeVariants, type ZardTableSortDirection } from '../../../components/table'
...
export function displayDensityToTableSize(
  displayDensity: DisplayDensity | string | null | undefined
): ZardTableSizeVariants {
