...
export const DATA_X_SEMANTIC_MODEL_LIST_CATALOGS_TOOL_NAME = 'semantic_model_list_catalogs'
export const DATA_X_SEMANTIC_MODEL_LIST_PROJECTS_TOOL_NAME = 'semantic_model_list_projects'
