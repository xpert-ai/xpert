...
import { ChatMessageEventTypeEnum, getToolCallIdFromConfig, TMessageComponent } from '@xpert-ai/contracts'
import { C_MEASURES, DataSettings, getEntityCalendar, getEntityProperty } from '@xpert-ai/ocap-core'
import { groupBy } from 'lodash'
import { t } from 'i18next'
import { firstValueFrom } from 'rxjs'
import { z } from 'zod'
import { TBIContext } from '../../../types'
import { BIToolsEnum } from '../bi-toolset'

/**
 * Build tool to show indicators visually.
 */
export function buildShowIndicatorsTool(context: TBIContext, isDraft = false) {
	const { dataPermission, dsCoreService } = context
