...
// import { ChatMessageEventTypeEnum, ChatMessageStepCategory, getToolCallIdFromConfig } from '@xpert-ai/contracts'
// import { AggregationRole, getEntityProperty2, PropertyLevel, wrapBrackets } from '@xpert-ai/ocap-core'
...
// export function buildDimensionMemberRetrieverTool(context: ChatBIContext, name: string) {
...
// 				new RetrieveMembersCommand(query || '*', { dsCoreService, modelId, cube, dimension, hierarchy, level, topK, reEmbedding: re_embedding })
// 			)
...
// 				re_embedding: z.boolean().optional().nullable().default(false).describe('Need re-embedding dimension members if the user explicitly requires, otherwise the default is false')
// 			})
// 		}
// 	)
// }
