...
export function isAgenticWorkflowType(type: WorkflowNodeTypeEnum | string | null | undefined) {
    return isAgentWorkflowNodeType(type) || type === WorkflowNodeTypeEnum.MIDDLEWARE
}
