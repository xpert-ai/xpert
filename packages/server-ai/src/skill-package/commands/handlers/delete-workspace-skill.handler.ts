import { DeleteWorkspaceSkillCommand, SkillCreatorToolResult } from '../../authoring/skill-creator-cqrs'
...
export class DeleteWorkspaceSkillHandler implements ICommandHandler<DeleteWorkspaceSkillCommand> {
    ...
    async execute(command: DeleteWorkspaceSkillCommand): Promise<SkillCreatorToolResult> {
        try {
            ...
            await this.skillPackageService.uninstallSkillPackageInWorkspace(
                command.workspaceId,
