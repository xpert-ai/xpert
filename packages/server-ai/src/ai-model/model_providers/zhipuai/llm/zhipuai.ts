...
import { convertEventStreamToIterableReadableDataStream } from "./event_source_parse";
...
export interface ChatZhipuAIParams {
  ...
  /**
   * The model has a built-in Internet search service. This parameter controls whether the model refers to Internet search results when generating text. When Internet search is enabled, the model will use the search results as reference information in the text generation process, but the model will "judge" whether to use Internet search results based on its internal logic.
   */
  web_search?: boolean
}
...
export class ChatZhipuAI extends BaseChatModel implements ChatZhipuAIParams {
  ...
  constructor(fields: Partial<ChatZhipuAIParams> & BaseChatModelParams = {}) {
    ...
    this.web_search = fields.web_search;
  }
