...
function resolveTaskTimeZone(taskTimeZone?: string | null, headerTimeZone?: string | string[]): string | undefined {
    const value = taskTimeZone ?? (Array.isArray(headerTimeZone) ? headerTimeZone[0] : headerTimeZone)
