...
import { XpertProjectActivity } from './project-activity.entity'
...
export class XpertProject extends TenantOrganizationBaseEntity implements IXpertProject {
    ...
    */
    ...
    @ApiPropertyOptional({ type: () => XpertProjectPlan, isArray: true })
    @OneToMany(() => XpertProjectPlan, (_) => _.project, { cascade: ['insert', 'update', 'remove'] })
    plans?: IXpertProjectPlan[]

    @ApiPropertyOptional({ type: () => XpertProjectActivity, isArray: true })
    @OneToMany(() => XpertProjectActivity, (_) => _.project, { cascade: ['insert', 'update', 'remove'] })
    activities?: IXpertProjectActivity[]

    @ApiPropertyOptional({ type: () => XpertProjectAsset, isArray: true })
    @OneToMany(() => XpertProjectAsset, (_) => _.project, { cascade: ['insert', 'update', 'remove'] })
    assets?: IXpertProjectAsset[]
