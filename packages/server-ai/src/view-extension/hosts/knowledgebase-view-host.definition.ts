...
import { ViewHostDefinition, ViewHostDefinitionContract } from '@xpert-ai/server-core'
...
export class KnowledgebaseViewHostDefinition implements ViewHostDefinitionContract {
