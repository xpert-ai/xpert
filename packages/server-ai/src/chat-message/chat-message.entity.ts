...
export class ChatMessage extends TenantOrganizationBaseEntity implements IChatMessage {
    ...
    */
    /**
     * @deprecated Chat attachments now use `fileAssets`; keep this relation only
     * for historical messages that still point directly at object storage files.
     */
    ...
    /**
     * File-understanding attachments visible to the agent through compact file
     * cards, parser artifacts, searchable chunks, and workspace projection.
     */
    @ManyToMany(() => FileAsset)
    @JoinTable({
        name: 'chat_message_file_asset'
    })
