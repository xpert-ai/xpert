...
export class PluginResourceInstallerService {
    ...
    private async resolveTemplateDependencyComponents(
        ...
        dependencies?: {
            plugins?: string[]
            skills?: Array<{ pluginName?: string; componentKey: string; targetAgentKey?: string }>
            mcpServers?: Array<{
                pluginName?: string
                componentKey: string
                targetAgentKey?: string
            ...
            hooks?: Array<{ pluginName?: string; componentKey: string; targetAgentKey?: string; events?: string[] }>
            apps?: Array<{ pluginName?: string; componentKey: string; auth?: 'on_install' | 'on_first_use' }>
        }
    ) {
