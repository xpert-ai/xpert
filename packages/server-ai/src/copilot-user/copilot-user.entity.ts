import { AiProvider, ICopilotUser, IOrganization, IUser } from '@xpert-ai/contracts'
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger'
import { IsNumber, IsOptional, IsString } from 'class-validator'
import { Column, Entity, Index, JoinColumn, ManyToOne, RelationId } from 'typeorm'
import { Organization, TenantOrganizationBaseEntity, User } from '@xpert-ai/server-core'
 ...
 */
@Entity('copilot_user')
@Index('IDX_copilot_user_scope_user_model_hour', [
    'tenantId',
    'organizationId',
    'userId',
    'provider',
...
@Index('IDX_copilot_user_scope_model_hour', ['tenantId', 'organizationId', 'provider', 'model', 'usageHour'])
@Index('IDX_copilot_user_scope_org_model', ['tenantId', 'organizationId', 'orgId', 'provider', 'model'])
