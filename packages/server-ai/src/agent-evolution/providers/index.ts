import { ConformanceTemplateProvider } from './conformance-template.provider'
...
export const AGENT_EVOLUTION_CONFORMANCE_PROVIDERS = [
    ConformanceFieldMappingProvider,
    ConformanceIntentRoutingProvider,
