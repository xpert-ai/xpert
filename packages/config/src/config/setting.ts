...
export default registerAs('setting', () => ({
    ...
    lark_login: flagFeatures.FEATURE_LARK_LOGIN,
    dingtalk_login: flagFeatures.FEATURE_DINGTALK_LOGIN,
    ...
    keycloak_login: flagFeatures.FEATURE_KEYCLOAK_LOGIN,

    mobile_verification_signup: process.env.AUTH_MOBILE_VERIFICATION_SIGNUP === 'true'
}));
