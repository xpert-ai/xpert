...
export default registerAs('app', () => ({
     ...
     * If not provided through the environment variable APP_NAME, defaults to 'XpertAI'.
     */
    app_name: process.env.APP_NAME || 'XpertAI',
     ...
     */
    app_logo: process.env.APP_LOGO || `${process.env.CLIENT_BASE_URL}/assets/logo.png`,

    /**
     * The URL of the login page background image.
     */
    app_auth_bg: process.env.APP_AUTH_BG,
}));
