...
export const prodEnvironment: IEnvironment = {
  ...
  dataOntologyUrl: process.env.DATA_ONTOLOGY_URL?.trim() || 'https://data.xpertai.cn/',
  production: true,
  envName: 'prod',
  ...
  facebookConfig: {
    ...
    oauthRedirectUri:
      process.env.FACEBOOK_CALLBACK_URL || `${process.env.HOST}:${process.env.PORT}/api/auth/facebook/callback`,
    state: '{fbstate}'
  },
  ...
  googleConfig: {
    ...
    callbackUrl: process.env.GOOGLE_CALLBACK_URL || `${process.env.HOST}:${process.env.PORT}/api/auth/google/callback`
  },
  ...
  githubConfig: {
    ...
    callbackUrl:
      process.env.GITHUB_CALLBACK_URL || `http://${process.env.HOST}:${process.env.PORT}/api/auth/google/callback`
  },
  ...
  microsoftConfig: {
    ...
    callbackUrl:
      process.env.MICROSOFT_CALLBACK_URL || `http://${process.env.HOST}:${process.env.PORT}/api/auth/microsoft/callback`
  },
  ...
  linkedinConfig: {
    ...
    callbackUrl:
      process.env.LINKEDIN_CALLBACK_URL || `http://${process.env.HOST}:${process.env.PORT}/api/auth/linked/callback`
  },
  ...
  twitterConfig: {
    ...
    callbackUrl:
      process.env.TWITTER_CALLBACK_URL || `http://${process.env.HOST}:${process.env.PORT}/api/auth/twitter/callback`
  },
  ...
  upworkConfig: {
    callbackUrl:
      process.env.UPWORK_CALLBACK_URL || `http://${process.env.HOST}:${process.env.PORT}/api/integrations/upwork`
  },
...
export const prodToggleFeatures: IPACFeatures = {
  ...
  FEATURE_XPERT_PROJECT:
    process.env.FEATURE_XPERT === 'false' || process.env.FEATURE_XPERT_PROJECT === 'false' ? false : true,
