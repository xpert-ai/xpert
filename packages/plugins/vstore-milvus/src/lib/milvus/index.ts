/**
 * @why Why modify this source code in langchain.js:
 * 
 * When multiple types of documents have different metadata fields in the same knowledge base, remove the mandatory check for non-existent metadata fields. @todo Are there any follow-up risks?
 * 
 * ```typescript
