...
export const flagFeatures: IAuthenticationFlagFeatures = {
	...
	FEATURE_LARK_LOGIN: featureEnabled(FeatureEnum.FEATURE_LARK_LOGIN),
	FEATURE_DINGTALK_LOGIN: featureEnabled(FeatureEnum.FEATURE_DINGTALK_LOGIN),
	...
	FEATURE_KEYCLOAK_LOGIN: featureEnabled(FeatureEnum.FEATURE_KEYCLOAK_LOGIN),
};
