...
- Storybook 停用改造：  
  删除 `libs/component-angular/project.json`、`packages/angular/project.json` 中 `storybook/build-storybook/static-storybook` targets；
  删除 `packages/angular/tsconfig.json`、`libs/component-angular/tsconfig.json` 的 `./.storybook/tsconfig.json` references；
