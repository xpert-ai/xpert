...
@Component({
  selector: 'xp-formly-accordion',
  standalone: false,
  templateUrl: './accordion-wrapper.component.html',
  styleUrls: ['./accordion-wrapper.component.scss'],
  host: {
    class: 'xp-formly-accordion'
  }
})
export class XpFormlyAccordionComponent<F extends FormlyFieldConfig = FormlyFieldConfig> extends FieldWrapper<F> {
