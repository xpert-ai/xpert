...
export class NbOAuth2AuthStrategy extends NbAuthStrategy {
  ...
  static setup(options: NbOAuth2AuthStrategyOptions): [PacAuthStrategyClass, NbOAuth2AuthStrategyOptions] {
  ...
  constructor(protected http: HttpClient,
              ...
              @Inject(PAC_WINDOW) protected window: any) {
    super();
  }
  ...
  protected createRefreshedToken(res, existingToken: NbAuthRefreshableToken, requireValidToken: boolean): PacAuthToken {
    type AuthRefreshToken = NbAuthRefreshableToken & PacAuthToken;
