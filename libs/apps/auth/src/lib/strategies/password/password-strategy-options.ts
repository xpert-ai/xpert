...
import { NbAuthSimpleToken, XpAuthTokenClass } from '../../services/token/token'
...
export class XpPasswordAuthStrategyOptions extends XpAuthStrategyOptions {
  ...
  token?: NbPasswordStrategyToken = {
    ...
    key: 'data.token',
    getter: (module: string, res: HttpResponse<Object>, options: XpPasswordAuthStrategyOptions) =>
      getDeepFromObject(res.body, options.token.key)
  }
  errors?: NbPasswordStrategyMessage = {
    key: 'data.errors',
    getter: (module: string, res: HttpErrorResponse, options: XpPasswordAuthStrategyOptions) =>
...
export const passwordStrategyOptions: XpPasswordAuthStrategyOptions = new XpPasswordAuthStrategyOptions()
