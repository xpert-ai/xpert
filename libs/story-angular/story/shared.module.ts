...
const MAT_MODULES = [ZardIconComponent, ZardButtonComponent, MatListModule, ...ZardTabsImports, ...ZardFormImports, ZardInputDirective, MatDialogModule, MatSidenavModule, MatTableModule, MatCheckboxModule, MatToolbarModule, MatTooltipModule, MatProgressBarModule, DragDropModule, PortalModule, LayoutModule, MatSlideToggleModule, MatProgressSpinnerModule, MatCardModule, MatExpansionModule]
@NgModule({
  declarations: [],
  imports: [
    CommonModule,
