...
import { XpPasswordAuthStrategy } from './password-strategy'
import { NbAuthResult } from '../../services/auth-result'
import { HttpClientTestingModule, HttpTestingController } from '@angular/common/http/testing'
import { RouterTestingModule } from '@angular/router/testing'
import { HttpErrorResponse, HttpResponse } from '@angular/common/http'
import { NbAuthSimpleToken, xpAuthCreateToken } from '../../services/token/token'

const ownerStrategyName = 'strategy'

describe('password-auth-strategy', () => {
  let strategy: XpPasswordAuthStrategy
  ...
  const successToken = xpAuthCreateToken(NbAuthSimpleToken, 'token', ownerStrategyName)
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [{ provide: XpPasswordAuthStrategy, useClass: XpPasswordAuthStrategy }]
    })
  })

  beforeEach(waitForAsync(
    inject([XpPasswordAuthStrategy, HttpTestingController], (_strategy, _httpMock) => {
      strategy = _strategy
      httpMock = _httpMock
