...
describe('XpertRemoteSelectComponent', () => {
  ...
  it('passes remote select params through as flat query parameters', () => {
    ...
    fixture.componentRef.setInput('url', '/api/xpert-workspace/connectors/select-options?provider=lark')
    ...
    const req = httpMock.expectOne(
      (request) =>
        request.urlWithParams === '/api/xpert-workspace/connectors/select-options?provider=lark&workspaceId=workspace-1'
    )
