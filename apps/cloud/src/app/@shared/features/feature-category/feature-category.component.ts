...
import { FeatureService, IFeatureOrganizationUpdateInput } from '@cloud/app/@core'
...
export class FeatureCategoryComponent {
  protected cva =
    inject<NgxControlValueAccessor<{ feature: IFeatureOrganizationUpdateInput; category: 'ai' | 'bi' | string }[]>>(
