...
<button class="absolute right-6 top-6 inline-flex justify-center items-center rounded-lg px-[10px] py-[6px] text-gray-900 text-[13px] font-medium border border-gray-200 hover:bg-gray-100" type="button"
