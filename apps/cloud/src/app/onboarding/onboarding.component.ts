...
<button class="absolute right-6 top-6 inline-flex items-center justify-center rounded-lg border border-divider-regular bg-components-card-bg px-[10px] py-[6px] text-[13px] font-medium text-text-primary shadow-sm transition-colors hover:bg-hover-bg" type="button"
