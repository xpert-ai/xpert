...
- 437dd75: Render schema-driven sliders with minimum, maximum, step and read-only constraints for numeric parser settings.
...
- 9a589df: browser automation & ralph loop
